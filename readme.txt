...
[Current development version:](http://wordpress.org/extend/plugins/shutter-reloaded/download/) Added alternate init option that loads Shutter earlier and works better, has option to replace the default gallery with Shutter powered one.
